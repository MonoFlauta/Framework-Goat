...
namespace FrameworkGoat
{
    ...
    {
        public static LayerControllerManager Instance
        {
            get
            {
                if (Instance == null) _instance = new LayerControllerManager(1);
                return _instance;
            }
        }

        private static LayerControllerManager _instance;

        private readonly List<LayerController> _layersControllers;
